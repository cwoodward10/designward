...
>
    <div class="mx-auto pb-8 max-w-page w-full flex flex-col md:flex-row justify-between md:items-center gap-4 border-b border-primary border-solid">
        <a class="no-underline" href="/">
            <h1 class="text-6xl md:text-hero leading-none">{currentTabName}</h1>
        </a>
        <div class="flex flex-col gap-2">
            <p class="md:max-w-[256px] line-clamp-2 text-right">{currentTabDescription}</p>
            <div class="ml-auto mr-0 flex items-center gap-2 divide-x divide-primary divide-solid">
