<footer class="absolute bottom-0 right-0 left-0 h-8 bg-offwhite drop-shadow-sm flex justify-between px-3">
    ...
    <article class="my-auto">
        <a class="my-auto flex space-x-1" href="https://github.com/cwoodward10/designward" alt="DesignWard" target="#">
            <img class="flex h-3 w-auto my-auto" src="./src/assets/logos/GitHub-Mark-32px.png" alt="Github Logo"/>
    ...
    <article class="my-auto flex space-x-1">
        ...
        <a class="h-3 my-auto" href="https://svelte.dev/"  alt="Svelte" target="#">
            <img class="h-3 w-auto" src="./src/assets/logos/svelte.png" alt="Svelte Logo"/>
        </a>
        <a class="h-3 my-auto" href="https://tailwindcss.com/" alt="Tailwind" target="#">
            <img class="h-3 w-auto" src="./src/assets/logos/tailwind.png" alt="Tailwind CSS Logo"/>
        </a>
    </article>
</footer>